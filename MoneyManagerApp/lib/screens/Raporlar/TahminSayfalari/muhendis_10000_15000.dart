...
class Muhendis1015 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Muhendis1015State();
}

class Muhendis1015State extends State<Muhendis1015> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/muhendis_10000_15000.txt');
    tahmin = gelen.split(" ");
