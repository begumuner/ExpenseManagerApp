...
class Mimar58 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Mimar58State();
}

class Mimar58State extends State<Mimar58> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/mimar_5000_8000.txt');
    tahmin = gelen.split(" ");
