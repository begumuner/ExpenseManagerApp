...
class Mimar1520 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Mimar1520State();
}

class Mimar1520State extends State<Mimar1520> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/mimar_15000_20000.txt');
    tahmin = gelen.split(" ");
