...
class Doctor1015 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Doctor1015State();
}

class Doctor1015State extends State<Doctor1015> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/doctor_10000_15000.txt');
    tahmin = gelen.split(" ");
