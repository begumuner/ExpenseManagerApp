...
class Muhendis25 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Muhendis25State();
}

class Muhendis25State extends State<Muhendis25> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/muhendis_2000_5000.txt');
    tahmin = gelen.split(" ");
