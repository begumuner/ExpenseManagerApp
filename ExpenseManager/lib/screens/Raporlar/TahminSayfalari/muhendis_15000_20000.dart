...
class Muhendis1520 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Muhendis1520State();
}

class Muhendis1520State extends State<Muhendis1520> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/muhendis_15000_20000.txt');
    tahmin = gelen.split(" ");
