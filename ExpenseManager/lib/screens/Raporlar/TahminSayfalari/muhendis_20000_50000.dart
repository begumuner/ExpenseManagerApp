...
class Muhendis2050 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Muhendis2050State();
}

class Muhendis2050State extends State<Muhendis2050> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/muhendis_20000_50000.txt');
    tahmin = gelen.split(" ");
