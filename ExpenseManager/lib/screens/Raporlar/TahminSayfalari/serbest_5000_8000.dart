...
class Serbest58 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Serbest58State();
}

class Serbest58State extends State<Serbest58> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/serbest_5000_8000.txt');
    tahmin = gelen.split(" ");
