...
class Serbest2050 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Serbest2050State();
}

class Serbest2050State extends State<Serbest2050> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/serbest_20000_50000.txt');
    tahmin = gelen.split(" ");
