...
class Doctor2050 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Doctor2050State();
}

class Doctor2050State extends State<Doctor2050> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/doctor_20000_50000.txt');
    tahmin = gelen.split(" ");
