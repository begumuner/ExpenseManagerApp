...
class Mimar810 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Mimar810State();
}

class Mimar810State extends State<Mimar810> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/mimar_8000_10000.txt');
    tahmin = gelen.split(" ");
