...
class Memur1520 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Memur1520State();
}

class Memur1520State extends State<Memur1520> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/memur_15000_20000.txt');
    tahmin = gelen.split(" ");
