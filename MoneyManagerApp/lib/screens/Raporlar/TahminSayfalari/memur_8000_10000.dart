...
class Memur810 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Memur810State();
}

class Memur810State extends State<Memur810> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/memur_8000_10000.txt');
    tahmin = gelen.split(" ");
