...
class Avukat1015 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Avukat1015State();
}

class Avukat1015State extends State<Avukat1015> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/avukat_10000_15000.txt');
    tahmin = gelen.split(" ");
