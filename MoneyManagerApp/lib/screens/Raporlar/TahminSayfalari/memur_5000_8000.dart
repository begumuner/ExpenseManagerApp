...
class Memur58 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Memur58State();
}

class Memur58State extends State<Memur58> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/memur_5000_8000.txt');
    tahmin = gelen.split(" ");
