...
class Doctor58 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Doctor58State();
}

class Doctor58State extends State<Doctor58> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/doctor_5000_8000.txt');
    tahmin = gelen.split(" ");
