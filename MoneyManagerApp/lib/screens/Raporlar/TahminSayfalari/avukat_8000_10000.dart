...
class Avukat810 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Avukat810State();
}

class Avukat810State extends State<Avukat810> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/avukat_8000_10000.txt');
    tahmin = gelen.split(" ");
