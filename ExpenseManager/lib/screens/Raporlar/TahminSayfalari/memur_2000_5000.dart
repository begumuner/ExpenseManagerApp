...
class Memur25 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Memur25State();
}

class Memur25State extends State<Memur25> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/memur_2000_5000.txt');
    tahmin = gelen.split(" ");
