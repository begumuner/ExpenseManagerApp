...
class Muhendis810 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Muhendis810State();
}

class Muhendis810State extends State<Muhendis810> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/muhendis_8000_10000.txt');
    tahmin = gelen.split(" ");
