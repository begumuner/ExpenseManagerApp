...
class Serbest810 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Serbest810State();
}

class Serbest810State extends State<Serbest810> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/serbest_8000_10000.txt');
    tahmin = gelen.split(" ");
