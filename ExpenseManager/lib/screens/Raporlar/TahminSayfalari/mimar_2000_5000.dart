...
class Mimar25 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Mimar25State();
}

class Mimar25State extends State<Mimar25> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/mimar_2000_5000.txt');
    tahmin = gelen.split(" ");
