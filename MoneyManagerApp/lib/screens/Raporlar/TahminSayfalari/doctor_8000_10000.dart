...
class Doctor810 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Doctor810State();
}

class Doctor810State extends State<Doctor810> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/doctor_8000_10000.txt');
    tahmin = gelen.split(" ");
