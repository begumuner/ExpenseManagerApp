...
class Serbest25 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Serbest25State();
}

class Serbest25State extends State<Serbest25> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/serbest_2000_5000.txt');
    tahmin = gelen.split(" ");
