...
class Mimar1015 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Mimar1015State();
}

class Mimar1015State extends State<Mimar1015> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/mimar_10000_15000.txt');
    tahmin = gelen.split(" ");
