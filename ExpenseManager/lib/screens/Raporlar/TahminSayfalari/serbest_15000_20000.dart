...
class Serbest1520 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Serbest1520State();
}

class Serbest1520State extends State<Serbest1520> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/serbest_15000_20000.txt');
    tahmin = gelen.split(" ");
