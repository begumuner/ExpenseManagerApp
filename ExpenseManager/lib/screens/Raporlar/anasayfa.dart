              ...
              children: <Widget>[
                GestureDetector(
                  child: _promotionCard(
                      '$meslek $maas', 'assets/images/profit.png'),
                  onTap: () {
                    if (meslek == "Mühendis") {
                      if (maas == "2000 - 5000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Muhendis25()));
                      }
                      if (maas == "5000 - 8000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Muhendis58()));
                      }
                      if (maas == "8000 - 10000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Muhendis810()));
                      }
                      if (maas == "10000 - 15000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Muhendis1015()));
                      }
                      if (maas == "15000 - 20000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Muhendis1520()));
                      }
                      if (maas == "20000 - 50000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Muhendis2050()));
                      }
                    }
                    if (meslek == "Doktor") {
                      if (maas == "2000 - 5000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Doctor25()));
                      }
                      if (maas == "5000 - 8000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Doctor58()));
                      }
                      if (maas == "8000 - 10000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Doctor810()));
                      }
                      if (maas == "10000 - 15000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Doctor1015()));
                      }
                      if (maas == "15000 - 20000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Doctor1520()));
                      }
                      if (maas == "20000 - 50000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Doctor2050()));
                      }
                    }
                    if (meslek == "Avukat") {
                      if (maas == "2000 - 5000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Avukat25()));
                      }
                      if (maas == "5000 - 8000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Avukat58()));
                      }
                      if (maas == "8000 - 10000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Avukat810()));
                      }
                      if (maas == "10000 - 15000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Avukat1015()));
                      }
                      if (maas == "15000 - 20000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Avukat1520()));
                      }
                      if (maas == "20000 - 50000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Avukat2050()));
                      }
                    }
                    if (meslek == "Memur") {
                      if (maas == "2000 - 5000") {
                        Navigator.pushReplacement(context,
                            MaterialPageRoute(builder: (context) => Memur25()));
                      }
                      if (maas == "5000 - 8000") {
                        Navigator.pushReplacement(context,
                            MaterialPageRoute(builder: (context) => Memur58()));
                      }
                      if (maas == "8000 - 10000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Memur810()));
                      }
                      if (maas == "10000 - 15000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Memur1015()));
                      }
                      if (maas == "15000 - 20000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Memur1520()));
                      }
                      if (maas == "20000 - 50000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Memur2050()));
                      }
                    }
                    if (meslek == "Mimar") {
                      if (maas == "2000 - 5000") {
                        Navigator.pushReplacement(context,
                            MaterialPageRoute(builder: (context) => Mimar25()));
                      }
                      if (maas == "5000 - 8000") {
                        Navigator.pushReplacement(context,
                            MaterialPageRoute(builder: (context) => Mimar58()));
                      }
                      if (maas == "8000 - 10000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Mimar810()));
                      }
                      if (maas == "10000 - 15000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Mimar1015()));
                      }
                      if (maas == "15000 - 20000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Mimar1520()));
                      }
                      if (maas == "20000 - 50000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Mimar2050()));
                      }
                    }
                    if (meslek == "Serbest Meslek") {
                      if (maas == "2000 - 5000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Serbest25()));
                      }
                      if (maas == "5000 - 8000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Serbest58()));
                      }
                      if (maas == "8000 - 10000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Serbest810()));
                      }
                      if (maas == "10000 - 15000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Serbest1015()));
                      }
                      if (maas == "15000 - 20000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Serbest1520()));
                      }
                      if (maas == "20000 - 50000") {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Serbest2050()));
                      }
                    }
                  },
                ),
                _promotionCard('', 'assets/images/cash-back.png'),
              ],
            ),
            SizedBox(height: 48),
          ],
