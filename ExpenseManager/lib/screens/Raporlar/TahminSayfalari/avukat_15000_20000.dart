...
class Avukat1520 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Avukat1520State();
}

class Avukat1520State extends State<Avukat1520> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/avukat_15000_20000.txt');
    tahmin = gelen.split(" ");
