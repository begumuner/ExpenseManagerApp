...
class Memur1015 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Memur1015State();
}

class Memur1015State extends State<Memur1015> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/memur_10000_15000.txt');
    tahmin = gelen.split(" ");
