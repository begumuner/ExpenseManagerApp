...
class Memur2050 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Memur2050State();
}

class Memur2050State extends State<Memur2050> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/memur_20000_50000.txt');
    tahmin = gelen.split(" ");
