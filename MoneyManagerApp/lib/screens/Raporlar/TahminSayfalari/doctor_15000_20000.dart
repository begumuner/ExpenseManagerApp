...
class Doctor1520 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Doctor1520State();
}

class Doctor1520State extends State<Doctor1520> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/doctor_15000_20000.txt');
    tahmin = gelen.split(" ");
