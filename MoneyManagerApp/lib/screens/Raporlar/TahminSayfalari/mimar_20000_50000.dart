...
class Mimar2050 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Mimar2050State();
}

class Mimar2050State extends State<Mimar2050> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/mimar_20000_50000.txt');
    tahmin = gelen.split(" ");
