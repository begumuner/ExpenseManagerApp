...
class Avukat2050 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Avukat2050State();
}

class Avukat2050State extends State<Avukat2050> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/avukat_20000_50000.txt');
    tahmin = gelen.split(" ");
