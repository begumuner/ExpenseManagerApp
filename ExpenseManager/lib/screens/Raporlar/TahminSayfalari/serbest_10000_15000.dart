...
class Serbest1015 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Serbest1015State();
}

class Serbest1015State extends State<Serbest1015> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/serbest_10000_15000.txt');
    tahmin = gelen.split(" ");
