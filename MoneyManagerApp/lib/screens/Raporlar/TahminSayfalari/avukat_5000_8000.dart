...
class Avukat58 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Avukat58State();
}

class Avukat58State extends State<Avukat58> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/avukat_5000_8000.txt');
    tahmin = gelen.split(" ");
