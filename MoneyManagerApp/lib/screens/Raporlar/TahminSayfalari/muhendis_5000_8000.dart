...
class Muhendis58 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Muhendis58State();
}

class Muhendis58State extends State<Muhendis58> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/muhendis_5000_8000.txt');
    tahmin = gelen.split(" ");
