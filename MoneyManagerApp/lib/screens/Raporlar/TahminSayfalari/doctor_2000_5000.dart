...
class Doctor25 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Doctor25State();
}

class Doctor25State extends State<Doctor25> {
  ...
  Future getDefaultLineSeries() async {
    String gelen = await getFileData('assets/ai/doctor_2000_5000.txt');
    tahmin = gelen.split(" ");
